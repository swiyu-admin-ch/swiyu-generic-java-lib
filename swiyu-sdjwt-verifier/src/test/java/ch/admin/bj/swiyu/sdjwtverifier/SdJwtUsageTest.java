 ...
 *
 * <p>This is an integration-style test that spans both {@code swiyu-sdjwt-builder} (test-scope
 * dependency) and {@code swiyu-sdjwt-verifier}, mirroring a real consumer's round-trip usage.</p>
 */
