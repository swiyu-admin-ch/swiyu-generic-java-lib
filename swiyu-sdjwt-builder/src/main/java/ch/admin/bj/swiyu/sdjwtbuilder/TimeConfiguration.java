...
public class TimeConfiguration {
    ...
    public Map<String, Object> getJSONTimes() {
        ...
        expiry.ifPresent(t -> times.put("exp", roundUp(t).getEpochSecond()));
        notBefore.ifPresent(t -> times.put("nbf", roundDown(t).getEpochSecond()));
        issuedAt.ifPresent(t -> times.put("iat", roundDown(t).getEpochSecond()));
        return times;
    }
     ...
     */
    private Instant roundUp(Instant instant) {
        return roundDown(instant)
     ...
     */
    private Instant roundDown(Instant instant) {
