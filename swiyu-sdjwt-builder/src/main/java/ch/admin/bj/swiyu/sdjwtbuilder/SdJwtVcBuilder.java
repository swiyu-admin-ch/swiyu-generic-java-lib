...
public class SdJwtVcBuilder {
     ...
     *
     * @throws SdJwtBuilderException if a required claim is missing in {@code vcClaims}, if a time claim is
     *                               provided through {@code vcClaims}, or if there is an error
     ...
     * @param jwt the signed Issuer-signed JWT
     * @param disclosures the Disclosures to append
     * @return the compact serialized SD-JWT
     */
