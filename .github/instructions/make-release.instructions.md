...
1. Öffne die Release-Seite: [https://github.com/swiyu-admin-ch/swiyu-generic-java-lib/releases](https://github.com/swiyu-admin-ch/swiyu-issuer/releases)
...
5. **Release title:** Gib `swiyu-generic-java-lib [VERSION_FROM_STEP_1]` ein.
